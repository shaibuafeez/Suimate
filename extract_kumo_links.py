...
OBJECT_TYPE = "0x57191e5e5c41166b90a4b7811ad3ec7963708aa537a8438c1761a5d33e2155fd::kumo::Kumo"
    ...
    if "result" in nft_data and "data" in nft_data["result"]:
        ...
        for nft in nfts:
            if "imageURL" in nft and nft["imageURL"]:
                # For Kumo NFTs, convert ipfs:// URLs to https://ipfs.io/ipfs/
...
def save_to_csv(image_links: List[str], filename="kumo_1000_links.csv"):
    """
...
def main():
    print("Extracting 1000 Kumo NFT image links...")

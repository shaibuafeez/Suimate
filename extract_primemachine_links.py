...
OBJECT_TYPE = "0x034c162f6b594cb5a1805264dd01ca5d80ce3eca6522e6ee37fd9ebfb9d3ddca::factory::PrimeMachin"
...
def save_to_csv(image_data: List[Dict[str, str]], filename="primemachine_1000_links.csv"):
    """
...
def main():
    print("Extracting 1000 Prime Machine NFT image links...")
